...
import error404  from "../../assets/errorPages/error-404.svg";
  ...
  return (
    <section className="max-w-[1440px] mx-auto flex flex-col items-center gap-0 pb-10 md:pb-8">
      ...
      <div className="flex flex-col items-center justify-center gap-2 sm:gap-3 text-center max-w-lg">
        <h3 className="text-cyan-500 capitalize text-2xl sm:text-3xl font-medium">
          page not found
        </h3>
        ...
        <button
          className="btns max-w-[200px] rounded-lg text-white py-2 px-8 mt-2 text-base"
          type="button"
          onClick={() => {
            navigate('/');
          }}
