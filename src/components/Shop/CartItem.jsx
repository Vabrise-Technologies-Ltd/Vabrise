      ...
      <div className="w-full min-h-[150px] flex items-center gap-x-4">
        ...
        <div className="w-full flex flex-col">
          ...
          <div className="flex gap-x-2 h-[36px] text-sm">
            <div className="flex flex-1 max-w-[100px] items-center h-full border text-cyan-500 font-medium">
            ...
            <div className="flex flex-1 justify-end items-center text-cyan-800 font-semibold">{`Ksh ${parseFloat(
              price * amount
            ).toFixed(2)}`}</div>
          </div>
        </div>
